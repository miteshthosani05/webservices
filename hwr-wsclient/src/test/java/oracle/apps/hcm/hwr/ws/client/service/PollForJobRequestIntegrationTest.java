...
/**
 * The Class PollForJobRequestIntegrationTest.
 */

public class PollForJobRequestIntegrationTest extends WsClientTest {

    /** Logger. */
    private static Log LOGGER = LogFactory.getLog(PollForJobRequestIntegrationTest.class);
     ...
     */
    @Test
    public void testPollForJobRequest() {
        String myResponseStr = mRequest.pollForJob(mConnectionInfo, "testPollForJobRequest");
